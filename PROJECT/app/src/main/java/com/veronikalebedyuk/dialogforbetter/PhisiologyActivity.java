...
public class PhisiologyActivity extends AppCompatActivity {
    ...
    private EditText sdi;
    private ListView insulineTypes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = findViewById(R.id.medCriteriaChoice);
    ...
    public void setPrefs(){
        ...
        prefs.edit().putInt("answer step",0).apply();
        prefs.edit().putInt("command type",0).apply();
        prefs.edit().putBoolean("first open", false).apply();
    }
